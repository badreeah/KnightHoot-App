    ...
    translation: {
      ...
      addDevice: {
        ...
        alerts: {
          ...
          saveFailUpdate:
            "Failed to update device. Check RLS policies.",
        },
      },
      ...
      manageAlerts: {
        ...
        alerts: {
          ...
          unreportSuccess:
            "{{channel}} unreported successfully.",
      ...
      smsScam: {
        ...
        startSuccess:
          "SMS scanning started successfully",
        ...
        allScanned:
          "🔄 All messages scanned. Restarting from beginning...",
        newSMS: "New SMS from",
        classificationError:
          "❌ Classification error. Check API connection.",
      ...
      settings: {
        ...
        BrowserProtection:
          "Browser Protection (Chrome Extension)",
      ...
      password: {
        ...
        errors: {
          ...
          noEmail:
            "Could not retrieve your email address.",
          wrongCurrent:
      ...
      email: {
        ...
        errors: {
          ...
          noEmail:
            "Could not retrieve your current email.",
          wrongPassword:
            "Incorrect password.",
        },
      ...
      // NEW: Browser Protection texts (for BrowserProtection screen)
      browserProtection: {
        cardTitle:
          "KnightHoot Detect – Chrome Extension",
        cardSubtitle:
          "Enable real-time URL scam detection directly in your desktop browser.",
        howTitle: "How does protection work?",
        howBody:
          "When you install the KnightHoot Detect extension on Chrome desktop, it checks every website you visit in real time and shows an alert if the URL looks risky or malicious.",
        stepsTitle: "Activation steps",
        steps: {
          s1: "Open this page on your computer (Chrome Desktop).",
          s2: "Install the KnightHoot Detect extension from the Chrome Web Store.",
          s3: "After installation, any website you visit will be scanned automatically and you'll see a warning if the link is suspicious.",
        },
        buttonLabel: "Open extension page",
        infoText:
          "Browser protection is currently available only on Chrome Desktop. The KnightHoot mobile app focuses on scanning messages and links, while the extension adds an extra protection layer while you browse on your laptop or PC.",
      },
    },
  },
    ...
    translation: {
      ...
      settings: {
        ...
        delete: {
          title: "حذف الحساب",
          message:
            "هل أنت متأكد؟ هذا الإجراء نهائي ولا يمكن التراجع عنه.",
          cancel: "إلغاء",
          confirm: "حذف",
        },
      ...
      privacy: {
        ...
        heading:
          "سياسة الخصوصية لتطبيق KnightHoot",
        lastUpdated:
      ...
      safe: {
        ...
        banner:
          "هذا الموقع يبدو مشبوها — تابع بحذر",
        ...
        report: "تبليغ",
        reportSent:
          "تم إرسال التقرير للنظام (تجريبي)",
      ...
      analyzeCall: {
        ...
        transcriptPlaceholder:
          "سيظهر نص المكالمة هنا...",
        micPermissionRequired:
          "مطلوب إذن الوصول إلى الميكروفون",
        noTranscription:
          "لا يوجد نص للمكالمة",
        uploadError:
          "حدث خطأ أثناء رفع الصوت",
        fetchError:
          "حدث خطأ أثناء جلب النص",
      ...
      addDevice: {
        ...
        emptySubtitle:
          "لم تقم بإضافة أي جهاز حتى الآن. ابدأ بإضافة أول جهاز لك.",
        ...
        alerts: {
          ...
          notAuthenticated:
            "المستخدم غير مسجل الدخول. يرجى تسجيل الدخول.",
          toggleFail:
            "فشل في تحديث حالة الجهاز.",
          deleteFail: "فشل في حذف الجهاز.",
          saveFailAdd:
            "فشل في إضافة الجهاز. تحقق من RLS policies.",
          saveFailUpdate:
            "فشل في تحديث الجهاز. تحقق من RLS policies.",
        },
      },
      ...
      manageAlerts: {
        ...
        sections: {
          sms: {
            uncertain:
              "تنبيهات الرسائل النصية غير المؤكدة",
            certain:
              "تنبيهات الرسائل النصية المؤكدة",
          },
          email: {
            uncertain:
              "رسائل البريد الإلكتروني المفحوصة",
            certain:
        ...
        empty: {
          sms: {
            uncertain:
              "لا توجد أي تنبيهات رسائل نصية غير مؤكدة.",
            certain:
              "لا توجد أي تنبيهات رسائل نصية مؤكدة.",
          },
          email: {
            uncertain:
              "لا توجد رسائل بريد إلكتروني مفحوصة.",
            certain:
              "لا توجد رسائل بريد إلكتروني مشبوهة.",
          },
        },
        ...
        titles: {
          suspiciousSms:
            "تم رصد رسالة نصية مشبوهة",
          smsScanned: "تم فحص الرسالة النصية",
          suspiciousEmail:
            "تم رصد بريد إلكتروني مشبوه",
        ...
        sms: {
          ...
          senderBlocked:
            "تم حظر مرسل الرسالة النصية",
          safe: "تم فحص الرسالة النصية وهي آمنة",
          detectedAt:
            "تم رصده في الساعة {{time}}",
        },

        email: {
          flagged:
            "تم وسمه كاحتيال محتمل",
        ...
        alerts: {
          ...
          errorTitle: "خطأ",
          fetchSmsError:
            "فشل في جلب بيانات الرسائل النصية.",
          reportSuccess:
            "تم الإبلاغ عن {{channel}} بنجاح.",
          reportError:
            "فشل في إتمام عملية الإبلاغ.",
          unreportSuccess:
            "تم إلغاء الإبلاغ عن {{channel}} بنجاح.",
          unreportError:
            "فشل في إلغاء الإبلاغ عن التنبيه.",
          restoreSuccess:
            "تم تجاهل التنبيه بنجاح.",
        },
      ...
      reportScam: {
        ...
        description: "الوصف",
        callDescPh:
          "صف ما حدث أثناء المكالمة",

        sender: "اسم/رقم المرسل",
        senderPh:
          "أدخل اسم أو رقم المرسل",
        ...
        thanks:
          "شكرًا لمساهمتك في حماية المستخدمين",
      ...
      smsScam: {
        ...
        waitingScan:
          "اضغط START للبدء في مراقبة الرسائل بحثاً عن الاحتيال.",
        monitoring:
          "جاري مراقبة الرسائل... بانتظار رسالة جديدة للتحليل.",

        startSuccess:
          "تم بدء فحص الرسائل بنجاح",
        stopSuccess:
          "تم إيقاف فحص الرسائل",
        ...
        allScanned:
          "🔄 تم فحص جميع الرسائل. إعادة البدء من جديد...",
        newSMS: "رسالة جديدة من",
        classificationError:
          "❌ خطأ في التصنيف. تحقق من اتصال API.",
      ...
      profile: {
        ...
        passwordPlaceholderApp:
          "أدخل كلمة مرور التطبيق (16 حرفًا)",
        emailError:
          "يرجى إدخال البريد الإلكتروني",
        passwordError16:
          "يرجى إدخال 16 حرفًا لكلمة المرور",
        ...
        connectedForScanning:
          "متصل للفحص",
        connectYourEmailToScan:
          "اربط بريدك الإلكتروني للفحص",

        emailDisconnectedSuccess:
          "تم فصل البريد الإلكتروني بنجاح.",
        emailDisconnectedFail:
          "حدث خطأ أثناء فصل البريد: ",
        disconnectEmailTitle:
          "هل تريد فصل البريد؟",
        disconnectEmailMessage:
          "هل أنت متأكد أنك تريد فصل {{email}}؟",
        disconnect: "فصل",

        emailConnectedSuccess:
          "تم ربط البريد الإلكتروني بنجاح.",
        emailConnectedFail:
          "تعذّر ربط البريد الإلكتروني: ",
      },

      // NEW: Browser Protection texts (Arabic)
      browserProtection: {
        cardTitle:
          "KnightHoot Detect – إضافة Chrome",
        cardSubtitle:
          "توفّر فحصًا لحظيًا لروابط الاحتيال مباشرة داخل المتصفح.",
        howTitle: "كيف تعمل الحماية؟",
        howBody:
          "عند تثبيت إضافة KnightHoot Detect على متصفح Chrome في جهاز الكمبيوتر، تقوم الإضافة بفحص أي موقع تزورينه لحظيًا وتعرض تنبيهًا يوضّح ما إذا كان الرابط آمنًا أو مشبوهًا.",
        stepsTitle: "خطوات التفعيل:",
        steps: {
          s1: "افتحي هذه الصفحة من جهاز الكمبيوتر (Chrome Desktop).",
          s2: "ثبّتي إضافة KnightHoot Detect من متجر Chrome Web Store.",
          s3: "بعد التثبيت، سيتم فحص المواقع التي تزورينها تلقائيًا مع تنبيه فوري إذا كان الرابط مشبوهًا.",
        },
        buttonLabel: "فتح صفحة الإضافة",
        infoText:
          "تعمل حماية المتصفح حاليًا على متصفح Chrome في أجهزة الكمبيوتر فقط. بينما يركّز تطبيق KnightHoot على الجوال على فحص الرسائل والروابط، تضيف الإضافة طبقة حماية إضافية أثناء التصفح على اللابتوب أو الكمبيوتر المكتبي.",
      },
    },
  },
};
