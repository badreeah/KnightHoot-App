...
const AlertsScreen = () => {
  ...
  const [animatedData, setAnimatedData] = useState(
    initialData.riskActivityToday.data.map(() => new Animated.Value(0))
  );
  ...
  const chartData =
    activeTab === "Today"
      ? initialData.riskActivityToday
      : initialData.riskActivityWeek;
      ...
      <View style={styles.headerContainer}>
        ...
        <View
          style={[
            ...
            { backgroundColor: theme.colors.cardBorder + "30" },
          ]}
        >
          ...
          return (
            ...
            >
              <Text
                style={
                  isActive
                    ? styles.sourceNameActive
                    : isSelectable
                    ? [styles.sourceNamePurple, { color: theme.colors.primary }]
              ...
              <Text
                style={
                  isActive
                    ? styles.sourceCountActive
                    : isSelectable
                    ? [
                        styles.sourceCountPurple,
                        { color: theme.colors.primary },
                      ]
                    : styles.sourceCountGrey
                }
              >
                {item.count}
              </Text>
