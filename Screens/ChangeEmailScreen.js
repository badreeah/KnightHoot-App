...
export default function ChangeEmailScreen() {
  ...
  const handleChangeEmail = async () => {
    ...
    try {
      ...
      // 2) تحديث الإيميل في Supabase Auth
      ...
      // 3) تحديث جدول profiles (اختياري لكن يفضل لتناسق البيانات)
      await updateMyProfile({ email: trimmedEmail });

      Alert.alert(
        "Check your email",
        "We sent a confirmation link to your new email. Please confirm it.",
        [
          {
            text: "OK",
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>{t("Change Email")}</Text>
            <View style={{ width: 24 }} />
          </View>
